          ...
          <div className="relative bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 w-full max-w-md mx-4">
            ...
            {isLogged ? (
              <p className="mb-6 text-sm text-foreground">
                La tua mail non è stata verificata. Per favore, controlla la tua
                casella di posta elettronica e conferma la tua registrazione. Se
                non hai ricevuto la mail, premi il pulsante qui sotto per
                inviarne un&apos;altra.
              </p>
            ) : (
              <p className="mb-6 text-sm text-foreground">
              ...
              {isLogged ? (
                ...
                <>
                  <Link className="xl:hidden w-full" href="/sign-up">
                    <RainbowButton>Accedi / Registrati</RainbowButton>
                  </Link>
