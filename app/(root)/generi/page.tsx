...
import { genres, MenuItem } from "@/data/data";
import { CategoriesOrGenresOrTopics } from "@/types";

const CategoriesPage = () => {
  const containerRef = useRef<HTMLDivElement>(null);
  const [categoriesState, setCategoriesState] = useState([null, genres[0]]);

  const [offset, setOffset] = useState("0%");
  const setCategory = (newCategory: MenuItem | null) => {
